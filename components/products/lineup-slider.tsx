...
export function LineupSlider({ products }: { products: ProductItem[] }) {
  ...
  // Ensure currentSet stays within valid range if totalSets changes
  const activeSet = currentSet >= totalSets ? 0 : currentSet;
    ...
    <div className="space-y-12">
      ...
      <div className="relative overflow-hidden px-4 md:px-0">
        <div
          ...
          style={{
            transform: `translateX(-${activeSet * 100}%)`,
          }}
        >
          {products.map((item) => (
            <div
            ...
            >
              <article className="group flex h-full flex-col rounded-[2rem] border border-black/8 bg-[#f6f7f9] p-4 shadow-[0_20px_55px_rgba(15,23,42,0.05)] transition-all duration-500 hover:-translate-y-1">
